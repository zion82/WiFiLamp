...
#define EFF_FAV               (28U)                         // любимый эффект под него будет отдельная кнопка / выбирается по номеру / пример 28U Nexus
...
#define RUNNING_TEXT_DEFAULT  ("Version 1.2.5 87")            // текст, который будет выводиться в эффекте Бегущая строка по умолчанию. его можно менять в приложении по
