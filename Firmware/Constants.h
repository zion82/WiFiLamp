...
// Там же задаётся время в секундах, которое ESP будет пытаться подключиться к WiFi сети, после его истечения автоматически развернёт WiFi точку доступа
#define	INTERNET_CHECK_PERIOD	(45UL)                      // Период повторной проверки наличия интернета в секундах
...
#define NTP_ADDRESS           ("pl.pool.ntp.org")           // сервер времени.               если не работает, пробуйте "time.windows.com"
...
#define CMD_LIST              (99U)
// -------------------------------------
String VERSION = "2.2 beta " + String(MODE_AMOUNT);
